...
public class GradedQuizAnswer implements Serializable, Comparable<GradedQuizAnswer> {
    ...
    @Override
    public int compareTo(@NonNull GradedQuizAnswer gradedQuizAnswer) {
        return (this.value.compareTo(gradedQuizAnswer.getValue()));
    }
}
